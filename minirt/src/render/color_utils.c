...
{
	return ((int)(color.x * 255.0) << 16) | ((int)(color.y
			* 255.0) << 8) | (int)(color.z * 255.0);
}
...
int	get_sky_color(t_ray ray)
{
	...
	/*
		* Gradient from blue (bottom) to white (top)
		* Blue: RGB(135, 206, 235) - Sky blue color
		* White: RGB(255, 255, 255)
		*/
	return ((int)((1.0 - grad) * 255 + grad * 135) << 16) | ((int)((1.0 - grad)
			* 255 + grad * 206) << 8) | (int)((1.0 - grad) * 255 + grad * 235);
}
