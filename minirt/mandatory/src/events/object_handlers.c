...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/21 21:29:27 by isallali          #+#    #+#             */
/*   Updated: 2025/08/21 21:29:28 by isallali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	handle_object_scale_rotation(int keycode, t_scene *scene)
{
	...
	{
		if (keycode == KEY_R)
			scene_rotate_object(scene, scene->selected_obj, vec3_create
				(0.2, 0, 0));
...
void	handle_object_translation(int keycode, t_scene *scene)
{
	if (keycode == KEY_P && scene->selected_obj < scene->num_objects - 1)
		...
		scene_translate_object(scene, scene->selected_obj, vec3_create
			(-0.3, 0, 0));
