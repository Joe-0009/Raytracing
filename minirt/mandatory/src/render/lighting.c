...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/21 21:30:38 by isallali          #+#    #+#             */
/*   Updated: 2025/08/21 21:30:39 by isallali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** where attenuation = 1.0 / (1.0 + ATTENUATION_LINEAR * distance
		+ ATTENUATION_QUADRATIC * distance²)
*/
t_color3	calculate_diffuse(const t_scene *scene, const t_hit *hit)
{
	...
	attenuation = 1.0 / (1.0 + ATTENUATION_LINEAR * distance
...
** - diffuse = light_intensity × light_color × object_color × max(0, dot(normal,
			light_dir)) × attenuation
*/
